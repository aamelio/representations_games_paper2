...
source_path = work_dir / "llm_batch_3.csv"
labels_path = work_dir / "batch3_part_2000_3133_labels.txt"
output_path = work_dir / "llm_batch_3_part_2000_3133.csv"

labels = "".join(labels_path.read_text(encoding="utf-8").split())
with source_path.open("r", encoding="utf-8-sig", newline="") as source_file:
    source_rows = list(csv.DictReader(source_file))[2000:3134]
...
if any(label not in "0123" for label in labels):
    raise ValueError("A label is outside 0-3")
