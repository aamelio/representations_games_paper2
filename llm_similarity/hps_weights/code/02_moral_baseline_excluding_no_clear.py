...
Usage:
    python 02_moral_baseline_excluding_no_clear.py fit
    python 02_moral_baseline_excluding_no_clear.py bootstrap --reps 500
    python 02_moral_baseline_excluding_no_clear.py all --reps 500
    python 02_moral_baseline_excluding_no_clear.py status
"""
