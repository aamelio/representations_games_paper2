#!/usr/bin/env python3
"""Extract the DG-C-neutral DOCX vignettes and build blinded round-9 inputs."""
...
VIGNETTE_SOURCE = HERE / "input" / "joint_action_vignettes_dg_c_neutral.docx"
...
def main() -> None:
    ...
    write_csv(HERE / "dg_c_neutral_vignettes_extracted.csv", list(vignettes[0]), vignettes)
    mapping = {
        "seed": SEED,
