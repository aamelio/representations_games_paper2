#!/usr/bin/env python3
"""Create the round-9 DOCX with two minimal DG-C wording revisions."""
...
SOURCE = HERE.parent / "round8" / "input" / "joint_action_vignettes_revised.docx"
OUTPUT = HERE / "input" / "joint_action_vignettes_dg_c_neutral.docx"
LOG = HERE / "dg_c_wording_changes.json"
