#!/usr/bin/env python3
"""Validate and combine the three blinded round-8 rating passes."""
...
def main() -> None:
    ...
    protocol = {
        "description": "Direct 1,000-point relative-similarity ratings of the revised vignettes, averaged across three separately tasked Codex agents.",
        ...
        "structural_choice_set": "all 22 revised vignettes",
