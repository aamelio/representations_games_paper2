"""Plot round-7 HP similarity means with participant-clustered 95% CIs.
...
def main() -> None:
    ...
    print(f"Wrote round-7 HP similarity figures and values to {OUTPUT}")
