...
- Structural stage: the target is evaluated against all 22 revised vignettes.
- Within-game stage: the target is evaluated only against the revised
  vignettes built around the same game structure (6 for DG and 8 each for UG
  and TG).
